...
import { ISpendWithDate } from '../../logic/spendsWorker';
...
const SpendWindow = ({ spendsArr }: ISpendWindowProps) => {
    return (
        <li className="flex justify-center items-center bg-gradient-to-br from-main-light to-main-dark rounded-tl-2xl rounded-tr-full rounded-br-2xl rounded-bl-full">
            <div className="w-2/3 h-2/3 text-main-yellow">
                <p className="pt-2">{`${spendsArr[0].date.getDate()}/${spendsArr[0].date.getMonth()}`}</p>
