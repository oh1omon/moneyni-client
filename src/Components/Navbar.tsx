...
const Navbar = (): JSX.Element => {
	return (
		<div className='fixed bottom-0 left-0 flex justify-center items-center w-full h-1/10 bg-main-dark'>
			<div className='rounded-t-2xl bg-gradient-to-t from-main-dark to-main-light w-full h-full flex justify-center items-center'>
